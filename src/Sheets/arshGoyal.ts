...
export const arshGoyalSheet: question[] = [
    ...
    {
        "QuestionName": "maximum points you can obtain from cards",
    ...
    {
        "QuestionName": "max value of equation",
    ...
    {
        "QuestionName": "insert delete getrandom o1 duplicates allowed",
    ...
    {
        "QuestionName": "smallest window in a string containing all the characters of another string 1587115621",
    ...
    {
        "QuestionName": "maximum size rectangle binary sub matrix 1s",
    ...
    {
        "QuestionName": "find number of islands",
    ...
    {
        "QuestionName": "given matrix o x replace o x surrounded x",
    ...
    {
        "QuestionName": "the kth factor of n",
    ...
    {
        "QuestionName": "permute two arrays sum every pair greater equal k",
    ...
    {
        "QuestionName": "find a pair with the given difference",
    ...
    {
        "QuestionName": "check reversing sub array make array sorted",
    ...
    {
        "QuestionName": "a product array puzzle",
    ...
    {
        "QuestionName": "make array elements equal minimum cost",
    ...
    {
        "QuestionName": "allocate minimum number of pages0937",
    ...
    {
        "QuestionName": "minimum number swaps required sort array",
    ...
    {
        "QuestionName": "convert binary number in a linked list to integer",
    ...
    {
        "QuestionName": "given only a pointer to a node to be deleted in a singly linked list how do you delete it",
    ...
    {
        "QuestionName": "stack set 4 evaluation postfix expression",
    ...
    {
        "QuestionName": "minimum cost tree from leaf values",
    ...
    {
        "QuestionName": "distance of nearest cell having 1 1587115620",
    ...
    {
        "QuestionName": "rotten oranges2536",
    ...
    {
        "QuestionName": "preorder to postorder4423",
    ...
    {
        "QuestionName": "print k sum paths binary tree",
    ...
    {
        "QuestionName": "find median bst time o1 space",
    ...
    {
        "QuestionName": "largest bst binary tree set 2",
    ...
    {
        "QuestionName": "construct bst from given preorder traversa",
    ...
    {
        "QuestionName": "bfs traversal of graph",
    ...
    {
        "QuestionName": "depth first search or dfs for a graph",
    ...
    {
        "QuestionName": "steps by knight5927",
    ...
    {
        "QuestionName": "strongly connected components kosarajus algo",
    ...
    {
        "QuestionName": "time needed to inform all employees",
    ...
    {
        "QuestionName": "#:~:text=Graph%20coloring%20problem%20is%20to,are%20colored%20using%20same%20color",
    ...
    {
        "QuestionName": "as far from land as possible",
    ...
    {
        "QuestionName": "find the city with the smallest number of neighbors at a threshold distance",
    ...
    {
        "QuestionName": "prims minimum spanning tree mst greedy algo 5",
    ...
    {
        "QuestionName": "implementing floyd warshall2042",
    ...
    {
        "QuestionName": "detect negative cycle graph bellman ford",
    ...
    {
        "QuestionName": "critical connections in a network",
    ...
    {
        "QuestionName": "travelling salesman problem set 1",
    ...
    {
        "QuestionName": "minimize cash flow among given set friends borrowed money",
    ...
    {
        "QuestionName": "trie insert and search",
    ...
    {
        "QuestionName": "furthest building you can reach",
    ...
    {
        "QuestionName": "find the most competitive subsequence",
    ...
    {
        "QuestionName": "cutted segments1642",
    ...
    {
        "QuestionName": "longest common substring1452",
    ...
    {
        "QuestionName": "count square submatrices with all ones",
    ...
    {
        "QuestionName": "mobile numeric keypad5456",
    ...
    {
        "QuestionName": "optimal binary search tree dp 24",
    ...
    {
        "QuestionName": "minimum insertion steps to make a string palindrome",
    ...
    {
        "QuestionName": "&sa=D&source=editors&ust=1651476654008730&usg=AOvVaw0jDrhU51BRCAP1M8_etno",
        "Link": "https://www.google.com/url?q=https://www.geeksforgeeks.org/largest-area-rectangular-sub-matrix-equal-number-1s-0s/&sa=D&source=editors&ust=1651476654008730&usg=AOvVaw0jDrhU51BRCAP1M8_etnoN",
        "Topic": [
            "Dynamic Programming"
        ],
        "Difficulty": "Difficult"
    ...
    {
        "QuestionName": "maximum number of visible points",
    ...
    {
        "QuestionName": "restore the array from adjacent pairs",
    ...
    {
        "QuestionName": "minimum deletions to make character frequencies unique",
    ...
    {
        "QuestionName": "minimum deletion cost to avoid repeating letters",
    ...
    {
        "QuestionName": "1&sa=D&source=editors&ust=1651476653976569&usg=AOvVaw3GNAgTQDilnSBWQ nAIn5",
        "Link": "https://www.google.com/url?q=https://practice.geeksforgeeks.org/problems/subset-sum-problem2014/1&sa=D&source=editors&ust=1651476653976569&usg=AOvVaw3GNAgTQDilnSBWQ-nAIn5w",
        "Topic": [
            "Backtracking"
        ],
        "Difficulty": "Medium"
    ...
    {
        "QuestionName": "1&sa=D&source=editors&ust=1651476653976680&usg=AOvVaw1BCeaXSqoasq9dHDOSCJW",
        "Link": "https://www.google.com/url?q=https://practice.geeksforgeeks.org/problems/m-coloring-problem-1587115620/1&sa=D&source=editors&ust=1651476653976680&usg=AOvVaw1BCeaXSqoasq9dHDOSCJWX",
        "Topic": [
            "Backtracking"
        ],
        "Difficulty": "Medium"
    ...
    {
        "QuestionName": "partition set k subsets equal sum",
    ...
    {
        "QuestionName": "solving cryptarithmetic puzzles backtracking 8",
    ...
    {
        "QuestionName": "print palindromic partitions string",
